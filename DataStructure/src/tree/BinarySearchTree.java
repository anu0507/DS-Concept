...
/**
 * For every node,Keys in left side are smaller and Keys in right side are
 * greater than parent node.
 * 
 * Operations on Binary Search Tree:- 1. add 2. contains 3. remove 4. size 5.
 * height
 */
